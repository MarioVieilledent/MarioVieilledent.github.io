...
const CulturalPattern = ({ motif }: { motif: ScriptCourseConfig["motif"] }) => {
  const pattern = {
    ...
    seigaiha: (
      <pattern id="script-pattern" width="96" height="48" patternUnits="userSpaceOnUse">
        <path d="M0 48A48 48 0 0 1 96 48M12 48a36 36 0 0 1 72 0M24 48a24 24 0 0 1 48 0M36 48a12 12 0 0 1 24 0" fill="none" stroke="currentColor" />
      </pattern>
    ),
    asanoha: (
      <pattern id="script-pattern" width="96" height="84" patternUnits="userSpaceOnUse">
        <path d="m48 0 48 28v56L48 112 0 84V28Zm0 0v56m0 0L0 28m48 28 48-28M48 56 0 84m48-28 48 28" fill="none" stroke="currentColor" />
      </pattern>
    ),
    kolam: (
      <pattern id="script-pattern" width="96" height="96" patternUnits="userSpaceOnUse">
        <path d="M24 8c22 0 22 32 0 32S2 72 24 72s22-32 0-32m48-32c-22 0-22 32 0 32s22 32 0 32-22-32 0-32M8 24c0 22 32 22 32 0S72 2 72 24 40 46 40 24m-32 48c0-22 32-22 32 0s32 22 32 0-32-22-32 0" fill="none" stroke="currentColor" strokeWidth="2" />
      </pattern>
    ),
  }[motif];
...
const CulturalMark = ({ motif, className = "" }: { motif: ScriptCourseConfig["motif"]; className?: string }) => {
  const path = {
    ...
    seigaiha: <><path d="M5 72a45 45 0 0 1 90 0M17 72a33 33 0 0 1 66 0M29 72a21 21 0 0 1 42 0M41 72a9 9 0 0 1 18 0" /><circle cx="50" cy="72" r="3" /></>,
    asanoha: <><path d="m50 3 45 26v52L50 107 5 81V29Zm0 0v52m0 0L5 29m45 26 45-26M50 55 5 81m45-26 45 26" /><circle cx="50" cy="55" r="4" /></>,
    kolam: <path d="M25 8c24 0 24 34 0 34S1 76 25 76s24-34 0-34m50-34c-24 0-24 34 0 34s24 34 0 34-24-34 0-34M8 25c0 24 34 24 34 0S76 1 76 25 42 49 42 25m-34 50c0-24 34-24 34 0s34 24 34 0-34-24-34 0" />,
  }[motif];
