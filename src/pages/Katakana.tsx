...
const config: ScriptCourseConfig = {
  ...
  description: "Master the 46 basic katakana through familiar loanwords, sound-by-sound reading practice, character cards, and quick recognition rounds.",
  ...
  formNote: "This course starts with the 46 basic gojūon. The long-vowel mark ー, voiced marks, small vowels, and combinations such as シャ extend the system.",
  ...
  footerNote: "Katakana is a phonetic Japanese syllabary, especially prominent in loanwords. Optional audio uses an installed Japanese browser voice.",
  motif: "asanoha",
  unitLabel: "kana",
