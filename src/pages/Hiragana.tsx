...
const config: ScriptCourseConfig = {
  ...
  description: "Learn the 46 basic hiragana plus all 25 dakuten and handakuten forms, open every character for real Japanese examples, and build reading confidence row by row.",
  ...
  formNote: "The 46 basic gojūon are followed by 20 dakuten and five handakuten kana. Combined sounds such as きゃ and the small っ build on these shapes.",
  ...
  footerNote: "Hiragana is a phonetic Japanese syllabary. This course covers the 46 basic modern signs plus 25 dakuten and handakuten forms; browser speech provides optional Japanese audio when a voice is installed.",
  motif: "seigaiha",
  unitLabel: "kana",
